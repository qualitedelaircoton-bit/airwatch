    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <Button 
          variant="outline" 
          size="icon" 
          className="h-9 w-9 bg-background/50 backdrop-blur-sm border-border/50 hover:bg-accent/80 transition-all duration-200"
        >
      ...
      <DropdownMenuContent align="end" className="glass-effect border-border/50 z-[9999]">
