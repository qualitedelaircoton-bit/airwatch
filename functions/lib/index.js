...
exports.approveAccessRequest = void 0;
...
exports.approveAccessRequest = functions.https.onCall(async (data, context) => {
    ...
    if (!email || !requestId) {
        throw new functions.https.HttpsError("invalid-argument", "The function must be called with an 'email' and 'requestId' argument.");
    }
    try {
        ...
        throw new functions.https.HttpsError("internal", "An internal error occurred while creating the user.", error);
    }
});
