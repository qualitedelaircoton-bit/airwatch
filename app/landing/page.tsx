        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div>
                <h5 className="font-semibold mb-4">Technologie</h5>
                <ul className="space-y-2 text-gray-400">
                  <li>Next.js 15 & React 19</li>
                  <li>Firebase Auth & Firestore</li>
                  <li>MQTT IoT Protocol</li>
                  <li>Capteurs temps réel</li>
                </ul>
              </div>
              <div>
                <h5 className="font-semibold mb-4">Accès</h5>
                <ul className="space-y-2 text-gray-400">
                  <li>Administrateurs : Gestion complète</li>
                  <li>Consultants : Lecture seule</li>
